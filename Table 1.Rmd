...
output_df<-rbind(output_df, make_table_row_continuous("BMI (not surv 2)", outcome_column, young_old_boundary = input_young_old_boundary, all_surveys))
...
output_df<-rbind(output_df, make_table_row_discrete("Hours.of.sleep.per.night_numeric (not surv 2)", outcome_column, young_old_boundary = input_young_old_boundary, all_surveys))
output_df<-rbind(output_df, make_table_row_discrete("Hours.of.sleep.per.night_numeric (not surv 1)", outcome_column, young_old_boundary = input_young_old_boundary, all_surveys))


output_df <- rbind(output_df, c("Excercise","", "", ""))
output_df<-rbind(output_df, make_table_row_discrete("Exercise.per.week_numeric (only surv 1)", outcome_column, young_old_boundary = input_young_old_boundary, all_surveys))
output_df<-rbind(output_df, make_table_row_discrete("sedentary_level (only surv 2-3)", outcome_column, young_old_boundary = input_young_old_boundary, all_surveys))
