...
# Run MetaAnalyse
Model1_results<-MetaAnalyse(survey1 = imp_survey1, survey2 = imp_survey2, survey3 = imp_survey3, model_name = "model_1", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
...
# Run MetaAnalyse
Model2_results<-MetaAnalyse(survey1 = imp_survey1, survey2 = imp_survey2, survey3 = imp_survey3, model_name = "model_2", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
...
# Run MetaAnalyse
Model3_results<-MetaAnalyse(survey1 = imp_survey1, survey2 = imp_survey2, survey3 = imp_survey3, model_name = "model_3", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
...
#Plot
plot_metaAnalysis(meta_df = Model1_results, xlabel = "Aging Pace (biological year/chronological year)", ylabel = "Term", vertical_line_value = 0, model_name = "model_1", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
plot_metaAnalysis(meta_df = Model2_results, xlabel = "Aging Pace (biological year/chronological year)", ylabel = "Term", vertical_line_value = 0, model_name = "model_2", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
plot_metaAnalysis(meta_df = Model3_results, xlabel = "Aging Pace (biological year/chronological year)", ylabel = "Term", vertical_line_value = 0, model_name = "model_3", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
plot_metaAnalysis(meta_df = Model1_z_results, xlabel = "Aging Pace (biological year/chronological year)", ylabel = "Term", vertical_line_value = 0, model_name = "model_1_z", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
plot_metaAnalysis(meta_df = Model2_z_results, xlabel = "Aging Pace (biological year/chronological year)", ylabel = "Term", vertical_line_value = 0, model_name = "model_2_z", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")
plot_metaAnalysis(meta_df = Model3_z_results, xlabel = "Aging Pace (biological year/chronological year)", ylabel = "Term", vertical_line_value = 0, model_name = "model_3_z", savePath = "C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/")