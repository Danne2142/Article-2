...
```{r}
df_crossectional <- read.csv("C:/Users/danwik/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Data/All_metrics_crossectional_samples.csv", header=TRUE, stringsAsFactors=FALSE)
