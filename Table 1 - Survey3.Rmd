...
```{r}
library(dplyr)
filtered_df_crossectional_harmonized <- read.csv("C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Output/filtered_df_crossectional_harmonized", header=TRUE, stringsAsFactors=FALSE)

survey3 <- filter(filtered_df_crossectional_harmonized, survey_version == 3)
...
```{r}
source("C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Program/format_pvalue().R")
source("C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Program/make_table_row_N_indivudals().R")
source("C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Program/make_table_row_discrete().R")
source("C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Program/make_table_row_continuous().R")
source("C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Program/fill_table_with_categorical().R")
...
# 
# #Seperate survey1
# survey1 <- seperate_survey1(filtered_df_crossectional_harmonized, collumns_to_use)
```
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Exercise.per.week",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE
...
# print(table(input_df$outcome_column, input_df$Immune.any))
...
# print(table(input_df$outcome_column, input_df$Diabetes1))
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Main.Diet",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
                                      display_only_true_vales = FALSE
                                      )) # Specify categories if needed

# The following creates rows for questions that are only in survey 2-3:

output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Primary.Diet.Past.Year",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Strictly.Followed.Main.Diet",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Red.Meat.times.per.week",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Processed.Food.times.per.week",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Feel.Well.Rested.days.per.week",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
...
output_df<-rbind(output_df, fill_table_with_categorical(df = input_df, replace_small_counts = TRUE, 
                                      categorical_var = "Track.Sleep.Wearable.Device",
                                      outcome_column = outcome_column,
                                      young_old_boundary = input_young_old_boundary,
                                      test_type = "chi",
                                      print_all_categories = TRUE,
...
output_df<-rbind(output_df, make_table_row_discrete("Hours.Sedentary.Remaining.Awake", outcome_column, young_old_boundary = input_young_old_boundary, input_df))
...
```{r}
df_Dunedin<-make_table_for_outcome(survey3, outcome_column = "DunedinPACE" , input_young_old_boundary=1) 

```
### Create dataframe for OMICmAge 
```{r}
df_OMICmAge<-make_table_for_outcome(survey3, outcome_column = "OMICmAgeAgeDev" , input_young_old_boundary=0) 

```
### Create dataframe for PC Grim Age 
```{r}
df_Grim<-make_table_for_outcome(survey3, outcome_column = "GrimAge.PCAgeDev" , input_young_old_boundary=0) 
...
write_xlsx(Table1, "C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Output/Table1_survey3.xlsx")
