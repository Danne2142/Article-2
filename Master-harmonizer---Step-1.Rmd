...
### Replace all empty strings with NA```{r}
...
### Save results
```{r}
write.csv(filtered_df_crossectional_harmonized, file = "C:/Users/danwik/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Output/data_after_step1", row.names = FALSE)
