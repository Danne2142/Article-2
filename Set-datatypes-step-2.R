...
source("C:/Users/danie/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Program/convert_to_logical().R")
...
data_fixed_datatypes<-convert_to_logical(data_fixed_datatypes, column_name="Menopause", false_values="No")

data_fixed_datatypes<-convert_to_logical(data_fixed_datatypes, column_name="Given.Birth", false_values="No")
