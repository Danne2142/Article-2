run_models_survey1 <- function(
  ...
  ggsave("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/fused_Model1SD_Survey1_plot.png", plot = fused_plot_model1)
  ...
  fused_plot_model2 <- forestplot_fusion(DunedinPACE, GrimAge, OmicAge,
                                         ...
                                         color_values = c("darkred", "navy", "forestgreen"),
                                         ylab ="Term", xlab = "SD")
  ggsave("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/fused_Model2SD_Survey1_plot.png", plot = fused_plot_model2)
  ...
  fused_plot_model3 <- forestplot_fusion(DunedinPACE, GrimAge, OmicAge,
                                         ...
                                         color_values = c("darkred", "navy", "forestgreen"),
                                         ylab ="Term", xlab = "SD")
  ggsave("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Project 2 - Vscode/Output/fused_Model3_Survey1_plot.png", plot = fused_plot_model3)
