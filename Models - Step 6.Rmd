...
df1_imp_data_surv1<-imputed_data$completedDatasets[[1]]
...
df1_imp_data_surv2<-imputed_data$completedDatasets[[1]]
...
df1_imp_data_surv3<-imputed_data$completedDatasets[[1]]
```
