...
# source("Z:/Project 2 - Vscode - copy/Program/set_NA_percent_and_imp_cols().R")
source("Z:/Project 2 - Vscode - copy/Program/mixed_correlation_matrix().R")
source("Z:/Project 2 - Vscode - copy/Program/imputationFunctions.R")
```
...
max_iterations_per_dataset = 40 #!!!!!!!!!!!!!!!!
#------------------------------------
#Load data
load("Z:/Project 2 - Vscode - copy/Output/data_after_step4")
...
#     output_dir= "Z:/Project 2 - Vscode - copy/Output", # Replace with your desired directory,
...
save(imputed_data, file = "Z:/Project 2 - Vscode - copy/Output/imputed_survey1")
...
# # Save the imputed datasets to a file
# save(imputed_data, file = paste0("Z:/Project 2 - Vscode - copy/Output/imputed_survey",surveyVersion,".RData"))
