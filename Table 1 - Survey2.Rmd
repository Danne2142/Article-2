...
survey2 <- filter(filtered_df_crossectional_harmonized, survey_version == 2)
...
```{r}
df_Dunedin<-make_table_for_outcome(survey2, outcome_column = "DunedinPACE" , input_young_old_boundary=1) 

```
### Create dataframe for OMICmAge 
```{r}
df_OMICmAge<-make_table_for_outcome(survey2, outcome_column = "OMICmAgeAgeDev" , input_young_old_boundary=0) 

```
### Create dataframe for PC Grim Age 
```{r}
df_Grim<-make_table_for_outcome(survey2, outcome_column = "GrimAge.PCAgeDev" , input_young_old_boundary=0) 
...
write_xlsx(Table1, "C:/Users/danie/OneDrive - Karolinska Institutet/Desktop/Project 2 ny/Output/Table1_survey2.xlsx")
