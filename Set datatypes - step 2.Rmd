...
```{r}
source("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Program/remove_other().R")
source("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Program/logical_to_integer().R")
source("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Program/convert_to_factors().R")
source("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Program/convert_yes_no_to_logical().R")
source("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Program/convert_to_logical().R")
source("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Program/char_cols_to_factors().R")


data <- read.csv("C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Output/data_after_step1", header=TRUE, stringsAsFactors=FALSE)
...
### Save data
```{r}
# write.csv(data_fixed_datatypes, file = "C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Output/data_after_step2", row.names = FALSE)
save(data_fixed_datatypes, file ="C:/Users/danwik/OneDrive - Karolinska Institutet/Documents/Output/data_after_step2")
