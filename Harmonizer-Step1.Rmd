...
### Import all data
```{r}
df_EPICv1_EPICv2_new <- read.csv("C:/Users/danie/Documents/Project 2 - Vscode/Data/EPICv1 and v2 data/All_metrics_crossectional_samples.csv", header=TRUE, stringsAsFactors=FALSE)
...
# df_EPICv1_old <- read.csv("C:/Users/danie/Documents/Project 2 - Vscode/Data/EPICv1 data/All_metrics_crossectional_samples.csv", header=TRUE, stringsAsFactors=FALSE)
```
...
```{r}
#Remove unnecessary text in searchword collumns
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/remove_unnecessary_strings().R")
...
```{r}
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/survey_version_functions.R")
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/process_supplement_data().R")
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/process_diet().R")
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/Users_without_searchwords().R")
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/replace_na_with_false().R")
source("C:/Users/danie/Documents/Project 2 - Vscode/Program/seperate_survey().R")
...
write.csv(df_EPICv1_EPICv2_new, file = "C:/Users/danie/Documents/Project 2 - Vscode/Output/df_EPICv1_EPICv2_new.csv", row.names = FALSE) # nolint
...
result_fasting <- process_diet(
  file_path = "C:/Users/danie/Documents/Project 2 - Vscode/Output/df_EPICv1_EPICv2_new.csv",
  supplement = "fasting",
...
### Save results
```{r}
write.csv(filtered_df_crossectional_harmonized, file = "C:/Users/danie/Documents/Project 2 - Vscode/Output/data_after_step1", row.names = FALSE)
